      ...
      <div style="padding: 30px; text-align: center;">
        <div style="
          ...
          <center style="padding: 15px;">
            ...
            <img src="https://cliply.co/wp-content/uploads/2019/07/391907100_HEART_400px.gif" alt="heart email" width="150"> 
            ...
            border-radius: 10px;
            max-width: 450px;
            word-break: break-word; font-family: Freadoka;">${content}</center>
